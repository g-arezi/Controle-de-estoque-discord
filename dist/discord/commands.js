...
const estoqueCommand = new discord_js_1.SlashCommandBuilder()
    ...
    .setRequired(false)
    .addChoices({ name: 'ITEMS', value: 'ITEMS' }, { name: 'SKINS', value: 'SKINS' }, { name: 'CONTAS', value: 'CONTAS' }, { name: 'PASSE', value: 'PASSE' }, { name: 'MODS', value: 'MODS' }, { name: 'AUXILIARES', value: 'AUXILIARES' }, { name: 'REGEDIT', value: 'REGEDIT' }, { name: 'DIGITAL', value: 'DIGITAL' }, { name: 'PHYSICAL', value: 'PHYSICAL' }, { name: 'OUTROS', value: 'OUTROS' }))
